...
public class SBP extends DialogPreference {
    ...
    public SBP(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SBP,
                0, 0);
        mMin = 50;// a.getInt(R.styleable.BetterSeekBarPreference_min, 0);
        mMax = 250;// a.getInt(R.styleable.BetterSeekBarPreference_max, 100);
        mValue = 100;// a.getInt(R.styleable.BetterSeekBarPreference_defaultValue,
                     // 0);
        a.recycle();

        setDialogLayoutResource(R.layout.sbp_dialog);
