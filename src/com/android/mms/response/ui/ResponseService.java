...
public class ResponseService extends Service
{
	...
	public void onStart(Intent intent, int startId)
	{
		...
		wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "AutoResponse");
	...
	private void createNotification()
	{
		...
		if(getNotifyCount() > 0)
		{
			...
			notification = new Notification(R.drawable.stat_notify_sms, getResources().getString(R.string.notification_ticker_start), System.currentTimeMillis());
			notification.setLatestEventInfo(this, getResources().getString(R.string.app_name), getMessageContent(false), PendingIntent.getActivity(this, 0, new Intent(this, ResponsePreferenceActivity.class), 0));
			
			if (!getLogStatus())
				getContactInfo();

			if (getName().equals(""))
				notification = new Notification(R.drawable.stat_notify_sms, getResources().getString(R.string.notification_ticker_replied) + " " + hyphenate(getReturnAddress()), System.currentTimeMillis());
			else
				notification = new Notification(R.drawable.stat_notify_sms, getResources().getString(R.string.notification_ticker_replied) + " " + getName() + " (" + hyphenate(getReturnAddress()) + ")", System.currentTimeMillis());
			
			notification.setLatestEventInfo(this, getResources().getString(R.string.app_name) + " (" + getNotifyCount() + ")", getMessageContent(false), PendingIntent.getActivity(this, 0, new Intent(this, ResponsePreferenceActivity.class), 0));
	...
	private void createNotificationFromString(String message)
	{
		...
		// Service started, first notification
		notification = new Notification(R.drawable.stat_notify_sms, message, System.currentTimeMillis());
		notification.setLatestEventInfo(this, getResources().getString(R.string.app_name), getMessageContent(false), PendingIntent.getActivity(this, 0, new Intent(this, ResponsePreferenceActivity.class), 0));
