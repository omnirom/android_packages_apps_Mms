...
public class MessageActivity extends ListActivity {
    ...
    private final String messagesFile = "AutoMessages.txt";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_messages_add:
            ...
            Button pButton = (Button) dialog
                    .findViewById(R.id.dialog_messagesButtonPositive_add);
            pButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    EditText eTitle = (EditText) dialog
                            .findViewById(R.id.dialog_messagesTitleEdit_add);
                    EditText eContent = (EditText) dialog
                            .findViewById(R.id.dialog_messagesContentEdit_add);

                    if (eTitle.getText().toString().equals("")
                            || eTitle.getText().toString().equals(null)
                            || eContent.getText().toString().equals("")
                            || eContent.getText().toString().equals(null))
                        ...
                        if (titleExists(eTitle.getText().toString()))
                            ...
                            Message newMessage = new Message(eTitle.getText()
                                    .toString().trim(), eContent.getText()
                                    .toString().trim());
                            messages.add(newMessage);
                            showTheMessage(MESSAGE_ADDED, eTitle.getText()
                                    .toString().trim());
                            dialog.cancel();
            ...
            Button nButton = (Button) dialog
                    .findViewById(R.id.dialog_messagesButtonNegative_add);
        ...
        case R.id.menu_messages_alphabetize:
            ...
            Toast alphabetizedToast = Toast.makeText(this,
                    r.getString(R.string.prompt_messages_alphabetized),
                    Toast.LENGTH_LONG);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        case CONTEXT_MENU_EDIT:
            ...
            dialog.setTitle(r.getString(R.string.menu_edit) + " "
                    + messages.get(iId).getTitle());

            Button pButton = (Button) dialog
                    .findViewById(R.id.dialog_messagesButtonPositive_edit);
            pButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    EditText eTitle = (EditText) dialog
                            .findViewById(R.id.dialog_messagesTitleEdit_edit);
                    EditText eContent = (EditText) dialog
                            .findViewById(R.id.dialog_messagesContentEdit_edit);
                    ...
                    if (eTitle.getText().toString().equals("")
                        ...
                        if ((messages.get(iId).getTitle().equals(eTitle
                                .getText().toString()))
                                && (messages.get(iId).getContent()
                                        .equals(eContent.getText().toString())))
                            dialog.cancel();

                        else {
                            messages.get(iId).setInfo(
                                    eTitle.getText().toString().trim(),
                                    eContent.getText().toString().trim());
                            showTheMessage(MESSAGE_SAVED, eTitle.getText()
                                    .toString().trim());
                            dialog.cancel();
                            saveMessages(messagesFile);

                            Log.i(TAG, "\"" + messages.get(iId).getTitle()
                                    + "\" edited successfully");
                            startActivity(getIntent());
                            finish();
                        }
            ...
            Button nButton = (Button) dialog
                    .findViewById(R.id.dialog_messagesButtonNegative_edit);
            nButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    dialog.cancel();
                }
        ...
        case CONTEXT_MENU_REMOVE:
            Log.i(TAG, "\"" + messages.get(info.position).getTitle()
                    + "\" removed");
    ...
    public void alphabetize() {
        for (int i = 0; i < messages.size(); i++)
            for (int j = 0; j < messages.size() - 1 - i; j++)
                if (messages.get(j).getTitle()
                        .compareTo(messages.get(j + 1).getTitle()) > 0) {
                    String tmpTitle = messages.get(j).getTitle();
                    String tmpContent = messages.get(j).getContent();

                    messages.get(j).setInfo(messages.get(j + 1).getTitle(),
                            messages.get(j + 1).getContent());
