...
import com.android.mms.morse.ui.Preferences;
...
public class MessagingPreferenceActivity extends PreferenceActivity implements
	...
	// Whether or not we are currently enabled for SMS. This field is updated in
	// onResume to make
	...
	private void loadPrefs() {
		...
		mNotificationPrefCategory = (PreferenceCategory) findPreference("pref_key_notification_settings");
		...
		mInputTypeEntries = getResources().getTextArray(
				R.array.pref_entries_input_type);
		mInputTypeValues = getResources().getTextArray(
				R.array.pref_values_input_type);
	...
	private void setMessagePreferences() {
				...
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						sharedPreferences.edit()
								.putInt(GESTURE_SENSITIVITY_VALUE, value)
								.commit();
		...
		int unicodeStripping = sharedPreferences.getInt(
				UNICODE_STRIPPING_VALUE, UNICODE_STRIPPING_LEAVE_INTACT);
		mUnicodeStripping.setValue(String.valueOf(unicodeStripping));
		mUnicodeStripping
				.setSummary(mUnicodeStrippingEntries[unicodeStripping]);
		mUnicodeStripping
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference preference,
						...
						int value = Integer.parseInt((String) newValue);
						sharedPreferences.edit()
								.putInt(UNICODE_STRIPPING_VALUE, value)
								.commit();
						mUnicodeStripping
								.setSummary(mUnicodeStrippingEntries[value]);
						return true;
					}
				});
		...
		String soundValue = sharedPreferences.getString(NOTIFICATION_RINGTONE,
				null);
		setRingtoneSummary(soundValue);

		// Read the input type value and set the summary
		String inputType = sharedPreferences.getString(
				MessagingPreferenceActivity.INPUT_TYPE,
	...
	private void setRingtoneSummary(String soundValue) {
		Uri soundUri = TextUtils.isEmpty(soundValue) ? null : Uri
				.parse(soundValue);
		Ringtone tone = soundUri != null ? RingtoneManager.getRingtone(this,
				soundUri) : null;
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		if (preference == mSmsLimitPref) {
			...
			mEnableQuickMessagePref.setEnabled(!mEnablePrivacyModePref
					.isChecked());

			// Update "enable dark theme" checkbox state
			mEnableQmDarkThemePref.setEnabled(!mEnablePrivacyModePref
					.isChecked());
	...
	public static boolean getPrivacyModeEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean privacyModeEnabled = prefs.getBoolean(
				MessagingPreferenceActivity.PRIVACY_MODE_ENABLED, false);
	...
	public static void enablePrivacyMode(boolean enabled, Context context) {
		...
		SharedPreferences.Editor editor = PreferenceManager
				.getDefaultSharedPreferences(context).edit();
		editor.putBoolean(MessagingPreferenceActivity.PRIVACY_MODE_ENABLED,
				enabled);
		editor.apply();
	}
	...
	public static boolean getQuickMessageEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean quickMessageEnabled = prefs.getBoolean(
				MessagingPreferenceActivity.QUICKMESSAGE_ENABLED, false);
	...
	public static void enableQuickMessage(boolean enabled, Context context) {
		...
		SharedPreferences.Editor editor = PreferenceManager
				.getDefaultSharedPreferences(context).edit();
		editor.putBoolean(MessagingPreferenceActivity.QUICKMESSAGE_ENABLED,
				enabled);
		editor.apply();
	}
	...
	public static boolean getQmLockscreenEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean qmLockscreenEnabled = prefs.getBoolean(
				MessagingPreferenceActivity.QM_LOCKSCREEN_ENABLED, false);
	...
	public static void enableQmLockscreen(boolean enabled, Context context) {
		SharedPreferences.Editor editor = PreferenceManager
				.getDefaultSharedPreferences(context).edit();
		editor.putBoolean(MessagingPreferenceActivity.QM_LOCKSCREEN_ENABLED,
				enabled);
		editor.apply();
	}
	...
	public static boolean getQmCloseAllEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean qmCloseAllEnabled = prefs.getBoolean(
				MessagingPreferenceActivity.QM_CLOSE_ALL_ENABLED, false);
	...
	public static void enableQmCloseAll(boolean enabled, Context context) {
		SharedPreferences.Editor editor = PreferenceManager
				.getDefaultSharedPreferences(context).edit();
		editor.putBoolean(MessagingPreferenceActivity.QM_CLOSE_ALL_ENABLED,
				enabled);
		editor.apply();
	}
	...
	public static void enableQmDarkTheme(boolean enabled, Context context) {
		SharedPreferences.Editor editor = PreferenceManager
				.getDefaultSharedPreferences(context).edit();
		editor.putBoolean(MessagingPreferenceActivity.QM_DARK_THEME_ENABLED,
				enabled);
		editor.apply();
	}
	...
	public static boolean getQmDarkThemeEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean qmDarkThemeEnabled = prefs.getBoolean(
				MessagingPreferenceActivity.QM_DARK_THEME_ENABLED, false);
